...
describe('DateTimeInput keyboard', () => {
    ...
    it('moves between days with ArrowRight and ArrowLeft', async () => {
        ...
        expect(getDay('Tuesday, March 31st, 2026')).toHaveFocus();
        await userEvent.keyboard('{ArrowLeft}{ArrowLeft}');
        expect(getDay('Sunday, March 29th, 2026')).toHaveFocus();
    });
    ...
    it('moves between weeks with ArrowDown and ArrowUp', async () => {
        ...
        expect(getDay('Monday, March 23rd, 2026')).toHaveFocus();
        await userEvent.keyboard('{ArrowDown}{ArrowDown}');
        expect(await screen.findByRole('button', { name: /^Monday, April 6th, 2026/ })).toHaveFocus();
    });
