import{r as l,j as d}from"./iframe-aq5zPLQA.js";import{C as t}from"./Checkbox-DS1z-z-z.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";const u={title:"Components/Checkbox",component:t,parameters:{layout:"centered"}},e={args:{"aria-label":"default example checkbox"}},r={args:{indeterminate:!0,"aria-label":"indeterminate example checkbox"}},a={render:o=>{const[n,c]=l.useState(!1),s=()=>{c(!n)};return d.jsx(t,{checked:n,"aria-label":"controlled checkbox",onChange:()=>s(),...o})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
