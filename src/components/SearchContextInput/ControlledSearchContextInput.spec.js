...
describe('SearchContextInput', () => {
    ...
    it('should display contextSearch', () => {
        render(
            <SearchContextInput variant="search"
...
describe('UncontrolledInput', () => {
    it('should have specified defaultValue', () => {
        render(<SearchContextInput defaultValue="test-default-value"/>);
    ...
    it('should reset field when we click on the reset button of the search input', () => {
        render(<SearchContextInput data-testid="moonstone-input" defaultValue="test-default-value" variant="search"/>);
...
describe('ControlledInput', () => {
    it('should display specified value', () => {
        render(<SearchContextInput value="test-value" onChange={() => {}}/>);
