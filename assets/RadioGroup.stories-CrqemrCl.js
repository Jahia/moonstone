import{j as e,r as m}from"./iframe-CwlF9BO-.js";import{a,R as d}from"./RadioItem-UtEIK1lC.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./RadioUnchecked-DjYtsntQ.js";import"./Typography-dTVHgYTN.js";const R={title:"Components/RadioGroup",component:d,subcomponents:{RadioItem:a},parameters:{layout:"centered",knobs:{disable:!0},storysource:{disable:!0},componentSubtitle:"RadioGroup & RadioItem",actions:{argTypesRegex:"^on.*"}},argTypes:{children:{table:{disable:!0}}}},i=n=>e.jsxs(d,{...n,children:[e.jsx(a,{id:"cat",label:"Cat",description:"Miaouw",value:"cat"}),e.jsx(a,{id:"dog",label:"Dog",description:"Ouah-ouah",value:"dog"}),e.jsx(a,{isDisabled:!0,id:"horse",label:"Horse",description:"Disabled element",value:"horse"}),e.jsx(a,{id:"bird",label:"Bird without description",value:"bird"})]}),r={render:i,args:{name:"no-default-value"}},t={render:i,args:{name:"default-value",defaultValue:"dog"}},o={render:i,args:{name:"disabled",isDisabled:!0}},s={render:n=>{const[u,c]=m.useState("cat"),p=l=>{c(l.target.value)};return e.jsxs(d,{...n,name:"controlled",value:u,onChange:l=>p(l),children:[e.jsx(a,{id:"dog1",label:"Dog",description:"Ouah-ouah",value:"dog"}),e.jsx(a,{id:"cat",label:"Cat",description:"Miaow",value:"cat"}),e.jsx(a,{id:"fish",label:"Fish",description:"blop",value:"fish"})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: Template,
  args: {
