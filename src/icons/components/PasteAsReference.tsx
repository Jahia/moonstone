...
const SvgPasteAsReference = ({
    ...
    return (
      ...
      {...props}
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1C13.3 1 14.4003 1.84 14.8203 3H19C20.1 3 21 3.9 21 5V9.43555C20.3414 9.30162 19.6652 9.27718 19 9.36133V5H17V8H7V5H5V21H9.43652C9.57855 21.6984 9.84326 22.3761 10.2305 23H5C3.9 23 3 22.1 3 21V5C3 3.9 3.9 3 5 3H9.17969C9.59969 1.84 10.7 1 12 1ZM12 3C11.45 3 11 3.45001 11 4C11 4.55 11.45 5 12 5C12.55 4.99996 13 4.54998 13 4C13 3.45003 12.55 3.00004 12 3Z"
      />
            <path d="M20.6064 16.3643L16.3643 20.6064L14.9502 19.1924L19.1924 14.9502L20.6064 16.3643Z"/>
            <path d="M19.8906 11.6533C20.9924 11.6474 21.938 12.0388 22.7275 12.8281C23.5054 13.6059 23.8945 14.5494 23.8945 15.6572C23.8944 16.7649 23.5053 17.7076 22.7275 18.4854L21.3135 19.8994L19.8994 18.4854L21.3135 17.0713C21.7023 16.6825 21.8974 16.211 21.8975 15.6572C21.8975 15.1033 21.7024 14.6311 21.3135 14.2422C20.9246 13.8535 20.4532 13.6592 19.8994 13.6592C19.3457 13.6592 18.8742 13.8535 18.4854 14.2422L17.0713 15.6572L15.6572 14.2422L17.0713 12.8281C17.849 12.0505 18.7889 11.6592 19.8906 11.6533Z"/>
        </svg>
    );
};
