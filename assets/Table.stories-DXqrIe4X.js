...
nested within the row will have their style change correspondingly`,name:`isHighlighted`,required:!1,type:{name:`boolean`}},children:{defaultValue:null,description:`The children elements`,name:`children`,required:!1,type:{name:`ReactNode`}}}}}catch{}var R=j.forwardRef(({iconStart:e,iconEnd:t,className:n,children:i,...a},o)=>(0,M.jsxs)(`div`,{ref:o,className:r(`moonstone-TableCell`,`flexRow_nowrap`,`alignCenter`,n),...a,children:[e&&(0,M.jsx)(e.type,{...e.props,className:r(`moonstone-icon_default`,e.props.className)}),i,t&&(0,M.jsx)(t.type,{...t.props,className:r(`moonstone-icon_default`,t.props.className)})]}));R.displayName=`FoundationTableCell`;try{FoundationTableCell.displayName=`FoundationTableCell`,FoundationTableCell.__docgenInfo={description:``,displayName:`FoundationTableCell`,props:{className:{defaultValue:null,description:`Additional classname`,name:`className`,required:!1,type:{name:`string`}},children:{defaultValue:null,description:`Children elements`,name:`children`,required:!1,type:{name:`ReactNode`}},cell:{defaultValue:null,description:`Cell object returned by react-table instance`,name:`cell`,required:!1,type:{name:`unknown`}},row:{defaultValue:null,description:`Row object returned by react-table instance`,name:`row`,required:!1,type:{name:`{ depth?: number; canExpand?: boolean; isExpanded?: boolean; getToggleRowExpandedProps?: (props?: Record<string, unknown>) => Record<string, unknown>; }`}},iconEnd:{defaultValue:null,description:`Icon to render at the end/right side of the cell`,name:`iconEnd`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},component:{defaultValue:null,description:`Name of the cell HTML element to render in the DOM`,name:`component`,required:!1,type:{name:`enum`,value:[{value:`"td"`},{value:`"th"`}]}},iconStart:{defaultValue:null,description:`Icon to render at the start/left side of the cell`,name:`iconStart`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},width:{defaultValue:null,description:`Define the width of the cell, if no width is set the column takes all space available. (e.g. '120px')`,name:`width`,required:!1,type:{name:`string`}},textAlign:{defaultValue:null,description:`How to align content horizontally within the table cell`,name:`textAlign`,required:!1,type:{name:`enum`,value:[{value:`"center"`},{value:`"right"`},{value:`"left"`}]}},verticalAlign:{defaultValue:null,description:`How to align content vertically within the table cell`,name:`verticalAlign`,required:!1,type:{name:`enum`,value:[{value:`"top"`},{value:`"bottom"`},{value:`"middle"`}]}},isExpandableColumn:{defaultValue:null,description:`If true, it indicates that the rows in this column have nested sub-rows and
that they should be displayed in a tree-like view`,name:`isExpandableColumn`,required:!1,type:{name:`boolean`}},isScrollable:{defaultValue:null,description:`Indicates if the cell is scrollable on hover`,name:`isScrollable`,required:!1,type:{name:`boolean`}}}}}catch{}var z=j.forwardRef(({component:e=`td`,textAlign:t=`left`,verticalAlign:n=`center`,className:a,iconStart:o,iconEnd:s,isExpandableColumn:c,width:l,row:u,children:d,isScrollable:f,...p},m)=>{let h=u?.depth*20,g=f?`moonstone-tableCellContent`:``,_=()=>(0,M.jsx)(k,{component:`div`,iconStart:o,iconEnd:s,typographyProps:{className:r(g,`flexFluid`)},children:d}),v=()=>c&&u?.canExpand?(0,M.jsxs)(R,{ref:m,...u?.getToggleRowExpandedProps({style:{marginLeft:`${h}px`}}),children:[u?.isExpanded?(0,M.jsx)(b,{className:`moonstone-marginRightNano`}):(0,M.jsx)(x,{className:`moonstone-marginRightNano`}),_()]}):c&&!u?.canExpand?(0,M.jsx)(R,{ref:m,style:{marginLeft:`${h+20}px`},children:_()}):(0,M.jsx)(R,{ref:m,children:_()});return(0,M.jsx)(T,{className:r(`moonstone-tableBodyCell`,`textAlign`+i(t),`moonstone-verticalAlign`+i(n),{flexFluid:l===void 0},a),component:e,variant:`body`,style:{width:l},...p,children:v()})});z.displayName=`TableBodyCell`;try{z.displayName=`TableBodyCell`,z.__docgenInfo={description:``,displayName:`TableBodyCell`,props:{className:{defaultValue:null,description:`Additional classname`,name:`className`,required:!1,type:{name:`string`}},children:{defaultValue:null,description:`Children elements`,name:`children`,required:!1,type:{name:`ReactNode`}},cell:{defaultValue:null,description:`Cell object returned by react-table instance`,name:`cell`,required:!1,type:{name:`unknown`}},row:{defaultValue:null,description:`Row object returned by react-table instance`,name:`row`,required:!1,type:{name:`{ depth?: number; canExpand?: boolean; isExpanded?: boolean; getToggleRowExpandedProps?: (props?: Record<string, unknown>) => Record<string, unknown>; }`}},iconEnd:{defaultValue:null,description:`Icon to render at the end/right side of the cell`,name:`iconEnd`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},component:{defaultValue:{value:`td`},description:`Name of the cell HTML element to render in the DOM`,name:`component`,required:!1,type:{name:`enum`,value:[{value:`"td"`},{value:`"th"`}]}},iconStart:{defaultValue:null,description:`Icon to render at the start/left side of the cell`,name:`iconStart`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},width:{defaultValue:null,description:`Define the width of the cell, if no width is set the column takes all space available. (e.g. '120px')`,name:`width`,required:!1,type:{name:`string`}},textAlign:{defaultValue:{value:`left`},description:`How to align content horizontally within the table cell`,name:`textAlign`,required:!1,type:{name:`enum`,value:[{value:`"center"`},{value:`"right"`},{value:`"left"`}]}},verticalAlign:{defaultValue:{value:`center`},description:`How to align content vertically within the table cell`,name:`verticalAlign`,required:!1,type:{name:`enum`,value:[{value:`"top"`},{value:`"bottom"`},{value:`"middle"`}]}},isExpandableColumn:{defaultValue:null,description:`If true, it indicates that the rows in this column have nested sub-rows and
that they should be displayed in a tree-like view`,name:`isExpandableColumn`,required:!1,type:{name:`boolean`}},isScrollable:{defaultValue:null,description:`Indicates if the cell is scrollable on hover`,name:`isScrollable`,required:!1,type:{name:`boolean`}}}}}catch{}var B=({component:e=`th`,width:t,textAlign:n=`left`,verticalAlign:a=`center`,className:o,iconStart:s,iconEnd:c,children:l,...u})=>(0,M.jsx)(T,{...u,className:r({flexFluid:t===void 0},`textAlign`+i(n),`moonstone-verticalAlign`+i(a),o),component:e,weight:`bold`,variant:`body`,style:{...u.style,width:t},children:(0,M.jsx)(R,{iconStart:s,iconEnd:c,children:l})});B.displayName=`TableHeadCell`;try{B.displayName=`TableHeadCell`,B.__docgenInfo={description:``,displayName:`TableHeadCell`,props:{ref:{defaultValue:null,description:``,name:`ref`,required:!1,type:{name:`Ref<HTMLTableDataCellElement> | Ref<HTMLTableHeaderCellElement>`}},className:{defaultValue:null,description:`Additional classname`,name:`className`,required:!1,type:{name:`string`}},component:{defaultValue:{value:`th`},description:`Name of the cell HTML element to render in the DOM`,name:`component`,required:!1,type:{name:`enum`,value:[{value:`"td"`},{value:`"th"`}]}},iconStart:{defaultValue:null,description:`Icon to render at the start/left side of the cell`,name:`iconStart`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},iconEnd:{defaultValue:null,description:`Icon to render at the end/right side of the cell`,name:`iconEnd`,required:!1,type:{name:`ReactElement<any, string | JSXElementConstructor<any>>`}},textAlign:{defaultValue:{value:`left`},description:`How to align content horizontally within the table cell`,name:`textAlign`,required:!1,type:{name:`enum`,value:[{value:`"center"`},{value:`"right"`},{value:`"left"`}]}},verticalAlign:{defaultValue:{value:`center`},description:`How to align content vertically within the table cell`,name:`verticalAlign`,required:!1,type:{name:`enum`,value:[{value:`"top"`},{value:`"bottom"`},{value:`"middle"`}]}},width:{defaultValue:null,description:`Define the width of the cell, if no width is set the column takes all space available. (e.g. '120px')`,name:`width`,required:!1,type:{name:`string`}},isExpandableColumn:{defaultValue:null,description:`If true, it indicates that the rows in this column have nested sub-rows and
that they should be displayed in a tree-like view`,name:`isExpandableColumn`,required:!1,type:{name:`boolean`}},row:{defaultValue:null,description:`Row object returned by react-table instance`,name:`row`,required:!1,type:{name:`{ depth?: number; canExpand?: boolean; isExpanded?: boolean; getToggleRowExpandedProps?: (props?: Record<string, unknown>) => Record<string, unknown>; }`}},cell:{defaultValue:null,description:`Cell object returned by react-table instance`,name:`cell`,required:!1,type:{name:`unknown`}},children:{defaultValue:null,description:`Children elements`,name:`children`,required:!1,type:{name:`ReactNode`}},isScrollable:{defaultValue:null,description:`Indicates if the cell is scrollable on hover`,name:`isScrollable`,required:!1,type:{name:`boolean`}}}}}catch{}var ee=`moonstone-tablePagination`,V=`moonstone-marginRight32`,te=`moonstone-marginRight16`,H=({className:e,label:t={rowsPerPage:`Rows per page`,of:`of`},rowsPerPage:n=10,rowsPerPageOptions:i=[5,10,25],totalNumberOfRows:a,currentPage:o,onRowsPerPageChange:s,onPageChange:c,...l})=>{if(o<1)throw Error(`currentPage must always be >= 1`);if(i.indexOf(n)===-1)throw Error(`rowsPerPage must exist in rowsPerPageOptions`);let u=Math.ceil(a/n),d=(o-1)*n+1,f=Math.min(a,o*n);return(0,M.jsxs)(`div`,{className:r(ee,`flexRow_reverse`,`alignCenter`,e),...l,children:[(0,M.jsx)(T,{variant:`caption`,children:t.rowsPerPage}),(0,M.jsx)(O,{className:r(`alignCenter`,te),size:`small`,"data-sel-role":`table-pagination-dropdown-rows-per-page`,data:i.map(e=>({label:e.toString(),value:e.toString()})),value:n.toString(),label:n.toString(),onChange:(e,t)=>s(parseInt(t.value,10))}),(0,M.jsx)(T,{variant:`caption`,className:r(ee,`flexRow_reverse`,`alignCenter`,V),"data-sel-role":`table-pagination-total-rows`,children:`${d}-${f} ${t.of} ${a}`}),(0,M.jsx)(E,{className:r(V),icon:(0,M.jsx)(p,{}),variant:`ghost`,"data-sel-role":`table-pagination-button-first-page`,isDisabled:o===1,onClick:()=>c(1)}),(0,M.jsx)(E,{className:r(V),icon:(0,M.jsx)(m,{}),variant:`ghost`,"data-sel-role":`table-pagination-button-previous-page`,isDisabled:o===1,onClick:()=>c(o-1)}),(0,M.jsx)(E,{className:r(V),icon:(0,M.jsx)(x,{}),variant:`ghost`,"data-sel-role":`table-pagination-button-next-page`,isDisabled:u===o,onClick:()=>c(o+1)}),(0,M.jsx)(E,{className:r(te),icon:(0,M.jsx)(g,{}),variant:`ghost`,"data-sel-role":`table-pagination-button-last-page`,isDisabled:u===o,onClick:()=>c(u)})]})};H.displayName=`TablePagination`;try{H.displayName=`TablePagination`,H.__docgenInfo={description:``,displayName:`TablePagination`,props:{className:{defaultValue:null,description:`Additional classname`,name:`className`,required:!1,type:{name:`string`}},rowsPerPage:{defaultValue:{value:`10`},description:`Current rows per page`,name:`rowsPerPage`,required:!1,type:{name:`number`}},rowsPerPageOptions:{defaultValue:{value:`[5, 10, 25]`},description:`Choices for rows per pages value`,name:`rowsPerPageOptions`,required:!1,type:{name:`number[]`}},onRowsPerPageChange:{defaultValue:null,description:`Callback when rowsPerPage value changes
