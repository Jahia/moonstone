...
export const FakePrimaryNavigation = (props: any) => {
    return (
        <nav {...props}
            style={{
...
export const FakeSecondaryNavigation = (props: any) => {
    return (
        <nav {...props}
             style={{
                writingMode: 'vertical-rl',
...
export const FakeHeader = (props: any) => {
    return (
        <header {...props}
            style={{
                width: '100%',
...
export const FakeContent = (placeholder: string = "content", hasLorem: boolean = false, props: any) => {
    return (
        <div {...props}
             style={{
            width: '100%',
