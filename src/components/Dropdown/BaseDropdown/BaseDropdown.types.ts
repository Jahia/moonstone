...
// Type dataProps =
//   | { isTree?: false; data: DropdownDataOption[] | DropdownData[] }
//   | { isTree: true; data: DropdownDataTree[] }

// type valueProps =
//     | { isMultiple?: false; value: string }
//     | { isMultiple: true; value: string[] }
...
export type BaseDropdownProps = {
    ...
    /**
     * The dropdown accepts multiple values
     */
    isMultiple?: boolean;
