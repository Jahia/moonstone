...
export const Thumbnail: React.FC<ThumbnailProps> = ({
    ...
    if (typeof src === 'string') {
        return (
            <div className={rootClassName} {...props}>
                <img
                    className={clsx(`moonstone-thumbnail_${variant}`, styles[`thumbnail_${variant}`])}
                    src={src}
                    alt={alt}
                    {...imgProps}
                />
    ...
    return (
        <div className={rootClassName} {...props}>
            <src.type
                {...src.props}
                className={clsx(`moonstone-thumbnail_${variant}`, styles[`thumbnail_${variant}`], src.props.className)}
            />
        </div>
    );
};
