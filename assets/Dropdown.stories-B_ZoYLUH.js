import{a as e,n as t}from"./chunk-BneVvdWh.js";import{a as n}from"./iframe-ocldAg4G.js";import{t as r}from"./jsx-runtime-CQFjE489.js";import{Ct as i,i as a,in as o,rn as s,wt as c}from"./icons-cGo7AZL_.js";import{n as l}from"./Pill-NI5s4-oP.js";import{d as u,f as d,g as f,h as p,l as m,m as h,p as g,t as _,u as v}from"./data-BH0uXXeg.js";var y,b=t((()=>{y=`data:text/markdown;base64,`})),x,S,C,w,T,E,D,O,k,A,j;t((()=>{x=e(n(),1),b(),i(),a(),o(),_(),S=r(),{action:C}=__STORYBOOK_MODULE_ACTIONS__,w={title:`Components/Dropdown`,component:c,parameters:{layout:`centered`,notes:{markdown:y},docs:{inlineStories:!1,IframeHeight:500}},argTypes:{icon:{options:Object.keys(s)}}},T={render:e=>{let[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(null),[a,o]=(0,x.useState)({label:`French`,value:`fr`,iconEnd:(0,S.jsx)(l,{label:`FR`})}),u=(e,t)=>(n(t),C(`onChange`)(e,t),!0),p=(e,t)=>(i(t),C(`onChangeImage`)(e,t),!0),m=(e,t)=>(o(t),C(`onChangePill`)(e,t),!0);return(0,S.jsxs)(`section`,{className:`storyGrid`,children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select something`,value:t?.value||null,isDisabled:e.isDisabled||!1,data:f,onChange:u}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,imageSize:e.imageSize||`small`,placeholder:e.placeholder||`Select an image`,value:r?.value||null,data:h,onChange:p}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select a language`,value:a.value,data:d,onChange:m})]})},args:{icon:`Love`}},E={render:e=>{let[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)([]),a=(e,t)=>(n(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0),o=(e,t)=>(i(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0);return(0,S.jsxs)(`section`,{className:`storyGrid`,children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:t.map(e=>e.value),placeholder:e.placeholder||`Select something`,data:f,onChange:(e,t)=>a(e,t)}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:r.map(e=>e.value),placeholder:e.placeholder||`Select languages`,data:u,onChange:(e,t)=>o(e,t)})]})},args:{icon:`Love`}},D={render:e=>{let[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(null),[a,o]=(0,x.useState)(null),l=(e,t)=>(n(t),C(`onChangeGrouped`)(e,t),!0),u=(e,t)=>(i(t),C(`onChangeImage`)(e,t),!0),d=(e,t)=>(o(t),C(`onChangeLanguage`)(e,t),!0);return(0,S.jsxs)(`section`,{className:`storyGrid`,children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select something`,value:t?.value||null,data:p,onChange:l}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select an image`,value:r?.value||null,data:v,onChange:u}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select a language`,value:a?.value||null,data:m,onChange:d})]})},args:{icon:`Love`}},O={render:e=>{let[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)([]),a=(e,t)=>(n(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0),o=(e,t)=>(i(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0);return(0,S.jsxs)(`section`,{className:`storyGrid`,children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:t.map(e=>e.value),placeholder:e.placeholder||`Select something`,data:p,onChange:(e,t)=>a(e,t)}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:r.map(e=>e.value),placeholder:e.placeholder||`Select languages`,data:m,onChange:(e,t)=>o(e,t)})]})},args:{icon:`Love`}},k={render:e=>{let[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(null),a=(e,t)=>(n(t),C(`onChangeTree`)(e,t),!0),o=(e,t)=>(i(t),C(`onChangeLanguage`)(e,t),!0);return(0,S.jsxs)(`section`,{children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select something`,value:t?.value||null,treeData:g,onChange:a}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,placeholder:e.placeholder||`Select a language`,value:r?.value||null,treeData:d,onChange:o})]})},args:{icon:`Love`}},A={render:e=>{let[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)([]),a=(e,t)=>(n(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0),o=(e,t)=>(i(e=>e.indexOf(t)>-1?e.filter(e=>e!==t):[...e,t]),C(`onChange`),!0);return(0,S.jsxs)(`section`,{className:`storyGrid`,children:[(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:t.map(e=>e.value),placeholder:e.placeholder||`Select something`,treeData:g,onChange:(e,t)=>a(e,t)}),(0,S.jsx)(c,{...e,icon:typeof e.icon==`string`&&s[e.icon]?x.createElement(s[e.icon]):e.icon,values:r.map(e=>e.value),placeholder:e.placeholder||`Select a language`,treeData:d,onChange:(e,t)=>o(e,t)})]})},args:{icon:`Love`}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
