...
export const ResizableBox: React.FC<ResizableBoxProps> = ({
    ...
    return (
        <Resizable
            ...
            handleClasses={
                {
                    right: clsx('moonstone-resizable_handle', styles.resizable_handle),
                    left: clsx('moonstone-resizable_handle', styles.resizable_handle)
                }
            }
            handleComponent={
                {
                    right: <HandleResize className={clsx('moonstone-resizable_handle_icon', styles.resizable_handle_icon)} size="big"/>,
                    left: <HandleResize className={clsx('moonstone-resizable_handle_icon', styles.resizable_handle_icon)} size="big"/>
                }
            }
