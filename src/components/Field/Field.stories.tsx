...
export const Default: Story = {
    args: {
        ...
        helper: 'information',
        children: <Input size="big" placeholder="Input value"/>
    }
};
...
export const WithTextarea: Story = {
    args: {
        ...Default.args,
        children: <Textarea id="moonstone-textarea" placeholder="Input value"/>
    }
};
...
export const WithRadio: Story = {
    args: {
        ...Default.args,
        children: <RadioGroup name="radio"><RadioItem id="radio1" label="Yes" value="Yes"/><RadioItem id="radio2" label="No" value="No"/></RadioGroup>
    }
};
...
export const WithListSelector: Story = {
    args: {
        ...Default.args,
        children: <ListSelector options={listSelectorData} label={{addAllTitle: 'add', removeAllTitle: 'remove', selected: 'selected'}} onChange={(v: string[]) => console.log(v)}/>
    }
};
...
export const WithCardSelector: Story = {
    args: {
        ...Default.args,
        children: <CardSelector id="cardSelector" displayName="Item name" systemName="system name" information="information" thumbnailType="icon"/>
    }
};
...
export const WithEmptyCardSelector: Story = {
    args: {
        ...Default.args,
        children: <EmptyCardSelector iconStart={<File/>} id="emptyCardSelector" label="Add item"/>
    }
};
