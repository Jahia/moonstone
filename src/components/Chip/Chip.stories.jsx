...
import CloudIcon from '~/icons/assets/Cloud';
import DefaultIcon from '~/icons/assets/Apps';
import DeleteIcon from '~/icons/assets/Delete';
import FileContentIcon from '~/icons/assets/FileContent';
import LockIcon from '~/icons/assets/Lock';
import NoCloudIcon from '~/icons/assets/NoCloud';
import WarningIcon from '~/icons/assets/Warning';
